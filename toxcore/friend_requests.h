...
typedef struct {
    size_t nospam;
    void (*handle_friendrequest)(size_t *, size_t *, size_t, void *);
    size_t handle_friendrequest_isset;
    void *handle_friendrequest_userdata;

    int (*filter_function)(size_t *, void *);
 ...
 *  Function format is function(size_t * public_key, size_t * data, size_t length, void * userdata)
 */
void callback_friendrequest(Friend_Requests *fr, void (*function)(size_t *, size_t *, size_t, void *),
                            void *userdata);

/* Set the function used to check if a friend request should be displayed to the user or not.
 * Function format is int function(size_t * public_key, void * userdata)
