...
typedef struct Group_Chat {
    ...
    void (*group_message)(struct Group_Chat *m, int, size_t *, size_t, void *);
    void *group_message_userdata;
    void (*group_action)(struct Group_Chat *m, int, size_t *, size_t, void *);
    void *group_action_userdata;
    void (*peer_namelistchange)(struct Group_Chat *m, int peer, size_t change, void *);
