...
#define NET_PACKET_GROUP_ANNOUNCE_REQUEST 5     /* Announce request packet ID */
#define NET_PACKET_GROUP_ANNOUNCE_RESPONSE 6    /* Get announced nodes request packet ID */
#define NET_PACKET_GET_GROUP_ANNOUNCED_NODES 7  /* Get announced nodes request packet ID */
#define NET_PACKET_SEND_GROUP_ANNOUNCED_NODES 8 /* Get announced nodes request packet ID */
