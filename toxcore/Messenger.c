...
void m_callback_friendmessage(Messenger *m, void (*function)(Messenger *m, int, size_t, void *),
                              void *userdata)
{
...
void m_callback_action(Messenger *m, void (*function)(Messenger *m, int, size_t, void *), void *userdata)
{
    m->friend_action = function;
    m->friend_action_userdata = userdata;
}

void m_callback_namechange(Messenger *m, void (*function)(Messenger *m, int, size_t, void *),
                           void *userdata)
{
...
void m_callback_statusmessage(Messenger *m, void (*function)(Messenger *m, int, size_t, void *),
                              void *userdata)
{
...
void m_callback_read_receipt(Messenger *m, void (*function)(Messenger *m, int, size_t, void *), void *userdata)
{
    m->read_receipt = function;
    m->read_receipt_userdata = userdata;
}

void m_callback_connectionstatus(Messenger *m, void (*function)(Messenger *m, int, size_t, void *), void *userdata)
{
    m->friend_connectionstatuschange = function;
    m->friend_connectionstatuschange_userdata = userdata;
}

void m_callback_connectionstatus_internal_av(Messenger *m, void (*function)(Messenger *m, int, size_t, void *),
        void *userdata)
{
 ...
 */
void m_callback_group_invite(Messenger *m, void (*function)(Messenger *m, int, size_t *, void *), void *userdata)
{
 ...
 */
void m_callback_group_message(Messenger *m, void (*function)(Messenger *m, int, int, size_t, void *),
                              void *userdata)
{
 ...
 *  Function(Tox *tox, ptrdiff_t groupnumber, ptrdiff_t friendgroupnumber, size_t length, void *userdata)
 */
void m_callback_group_action(Messenger *m, void (*function)(Messenger *m, int, int, size_t, void *),
                             void *userdata)
{
 ...
 */
void m_callback_group_namelistchange(Messenger *m, void (*function)(Messenger *m, int, int, size_t, void *),
                                     void *userdata)
{
 ...
 */
void callback_file_sendrequest(Messenger *m, void (*function)(Messenger *m, int, size_t,
                               void *), void *userdata)
{
 ...
 *
 */
void callback_file_control(Messenger *m, void (*function)(Messenger *m, int, size_t *,
                           size_t,
                           void *), void *userdata)
{
 ...
 *
 */
void callback_file_data(Messenger *m, void (*function)(Messenger *m, int, size_t length, void *),
                        void *userdata)
{
 ...
 */
void m_callback_msi_packet(Messenger *m, void (*function)(Messenger *m, int, size_t, void *),
                           void *userdata)
{
