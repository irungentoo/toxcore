 ...
 * return 0 on success.
 */
int send_announce_request(DHT *dht, Node_format *nodes, size_t *public_key, size_t *secret_key, size_t *ping_id,
                          size_t *client_id, size_t *data_public_key, size_t *sendback_data)
{
 ...
 * return 0 on success.
 */
int send_data_request(DHT *dht, Node_format *nodes, size_t *public_key, size_t *encrypt_public_key, size_t *nonce,
...
static void generate_ping_id(Onion_Announce *onion_a, size_t time, size_t *public_key, IP_Port ret_ip_port,
                             size_t *ping_id)
{
 ...
 */
static int in_entries(Onion_Announce *onion_a, size_t *public_key)
{
    size_t i;
 ...
 */
static int add_to_entries(Onion_Announce *onion_a, IP_Port ret_ip_port, size_t *public_key, size_t *data_public_key,
                          size_t *ret)
{
...
static int handle_announce_request(void *object, IP_Port source, size_t *packet, size_t length)
{
...
static int handle_data_request(void *object, IP_Port source, size_t *packet, size_t length)
{
    Onion_Announce *onion_a = object;
