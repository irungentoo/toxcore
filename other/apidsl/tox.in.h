 ...
 *
 * Set to 0 when the major or minor version number is incremented.
 */
...
namespace file {
  ...
  enum KIND {
    ...
    /**
     * File type for a "small" image in png format. Sticker are inline images similar in intent to emoji, but should be
     * their own 'message' and shouldn't share a line with existing or later text. In contrast with standard inline
     * images, stickers should be made available by the client, static, and multi use. Allowing other clients to save
     * bandwidth by storing stickers for later use.
     *
     * This image should have a file_id generated by `$hash` to allow clients to save this image file for reuse, and
     * later reference. Because stickers are expected to be saved, receiving clients should send ${CONTROL.CANCEL}
     ...
     * message.
     *
     * The format for this file type must be in raw opus format: https://www.opus-codec.org/docs/
     *
     * Senders should expect that files for this filetype will be renamed by the receiving client, allowing the sender
     * to use the filename as the bitrate selected for the audio.
     *
