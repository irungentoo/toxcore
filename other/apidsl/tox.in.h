...
namespace file {
  ...
  enum KIND {
    ...
    /**
     * File type for a "small" image. PNG format is default in toxcore.
     *
     * Sticker are inline images similar in intent to emoji, but should be their own 'message' and shouldn't share a
     * line with existing or later text. In contrast with standard inline images, stickers should be made available by
     * the client, static, and multi use. Allowing other clients to save bandwidth by storing stickers for later use.
     *
