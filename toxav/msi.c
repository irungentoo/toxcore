...
static void msi_handle_packet ( Messenger *messenger, int source, const uint8_t *data, uint16_t length, void *object )
{
    ...
    if ( msg->request.exists ) { /* Handle request */
        ...
        switch(msg->request.value) {
            case invite: handle_recv_invite ( session, call, msg ); break;
            case start: handle_recv_start ( session, call, msg ); break;
            case cancel: handle_recv_cancel ( session, call, msg ); break;
            case reject: handle_recv_reject ( session, call, msg ); break;
            case end: handle_recv_end ( session, call, msg ); break;
        }
        ...
        switch(msg->response.value) {
            case ringing: handle_recv_ringing ( session, call, msg ); break;
            case starting: handle_recv_starting ( session, call, msg ); break;
            case ending: handle_recv_ending ( session, call, msg ); break;
            case error: handle_recv_error ( session, call, msg ); break;
        }
